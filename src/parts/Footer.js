      ...
      <div className="container flex-col mx-auto ">
        <div className="flex flex-col sm:flex-row mt-8 justify-center">
          ...
          <div className="w-1/3 ml-16 sm:ml-0 mt-0">
            ...
            <Button href="https://www.instagram.com/yaaarmohan/" type="link" target="_blank" className="flex text-lg text-text-dark font-light hover:text-accent hover:underline" isExternal>
              Instagram
            </Button>
            <Button href="https://www.linkedin.com/in/mohan-mamidala" type="link" target="_blank" className="flex text-lg text-text-dark font-light hover:text-accent hover:underline" isExternal>
              LinkedIn
            </Button>
            <Button href="https://github.com/MohanMT" type="link" target="_blank" className="flex text-lg text-text-dark font-light hover:text-accent hover:underline" isExternal>
              Github
            </Button>
          </div>
        </div>
